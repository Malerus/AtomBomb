...
#define PRICE_CHEAP_AS_FREE		4     // -
#define PRICE_REALLY_CHEAP		8   // low end ammo.
#define PRICE_PRETTY_CHEAP		14    // -
#define PRICE_CHEAP				18    //  Normal ammo?
#define PRICE_ALMOST_CHEAP		24    // cosmetic clothing
#define PRICE_BELOW_NORMAL		28    // -
#define PRICE_NORMAL			34    // Useful clothing.
#define PRICE_ABOVE_NORMAL		38    // low end healing items
#define PRICE_ALMOST_EXPENSIVE	54    // Stimpaks, t3 machine parts.
#define PRICE_EXPENSIVE			68    // -
#define PRICE_ABOVE_EXPENSIVE	84    // Super Stimpaks, higher end weapons
